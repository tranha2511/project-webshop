...
//        index.php?controller=&action=&page=3
  ...
  public function getPrevPage() {
    ...
    if ($current_page >= 2) {
      ...
      $prev_page = "<li class='li-pagination'><a class='a-pagination' href='$prev_url'>Prev</a></li>";
    }
    return $prev_page;
  }
  ...
  public function getNextPage() {
    ...
    if ($current_page < $total_page) {
      ...
      $next_url =
        "index.php?controller=$controller&action=$action&page=$page";
      $next_page = "<li class='li-pagination'><a class='a-pagination' href='$next_url'>Next</a></li>";
    }
    return $next_page;
  }
    ...
    if ($this->params['full_mode'] == FALSE) {
      for ($page = 1; $page <= $total_page; $page++) {
        ...
        if ($page == 1 || $page == $total_page || $page  == $current_page - 1 || $page == $current_page + 1) {
          ...
          $data .= "<li class='li-pagination'><a class='a-pagination' href='$page_url'>$page</a></li>";
        }
        //nếu là trang hiện tại thì sẽ ko có link
        else if ($page == $current_page) {
          $data .= "<li class='active li-pagination'><a class='a-pagination' href=''>$page</a></li>";
        }
//        còn nếu hoặc là trang 2, trang 3 hoặc trang tổng - 1, trang tổng -2 thì hiển thị ..
          ...
          $data .= "<li class='li-pagination'><a class='a-pagination' href=''>...</a></li>";
        }
      }
