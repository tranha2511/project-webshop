    ...
    <form action="" method="POST">
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <h4 class="center-align" style="font-weight: bold">Thông tin khách hàng</h4>
            ...
            <div class="col-md-6 col-sm-6">
                <h4 class="center-align" style="font-weight: bold">Thông tin đơn hàng của bạn</h4>
              <?php
                              ...
                              <td>
                                <?php if (!empty($cart['avatar'])): ?>
                                    <img class="product-avatar img-responsive"
                                         src="assets/img/uploads/products/<?php echo $cart['avatar']; ?>" width="150"/>
                                <?php endif; ?>
                                  <div class="content-product" style="margin-top: 10px">
                                      <span href="<?php echo $product_link; ?>" class="content-product-a">
                                        <?php echo $cart['name']; ?>
                                      </span>
                                  </div>
                              </td>
        ...
        <input type="submit" name="submit" value="Thanh toán" class="btn btn-primary btn-click">
    </form>
</div>